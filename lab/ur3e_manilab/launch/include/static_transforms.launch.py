...
calibrations_dict = {
    ...
    'ur3e_manilab': {
        'world_pose_realsense_1': {
            'parent_frame': 'world',
            'child_frame': 'camera_1_link',
            'translation': [0.430779, 0.740722, 0.550364],
            'rotation': [-0.285854, -0.114417, 0.887148, -0.343751],  # [qx, qy ,qz, qw]
        },
        'world_pose_base_link': {
            'parent_frame': 'world',
            'child_frame': 'base_link',
        ...
        'object_pose_grasp_frame': {
            ...
            'child_frame': 'goal_frame',
            'translation': [0.043, 0.359, 0.065],
            'rotation': [0.553, 0.475, -0.454, 0.513],
        },
    },
...
try:
    _share_dir = get_package_share_directory('isaac_ros_manipulation_bringup')
    _unified_calib_path = os.path.join(_share_dir, 'config', 'sensors', 'unified_calibration.json')
    if os.path.exists(_unified_calib_path):
        with open(_unified_calib_path, 'r') as _f:
            _calib_data = json.load(_f)
        
        if 'ur3e_manilab' not in calibrations_dict:
            calibrations_dict['ur3e_manilab'] = {}
        
        # Map world_to_base_link
        _wbl = _calib_data['world_to_base_link']
        calibrations_dict['ur3e_manilab']['world_pose_base_link'] = {
            'parent_frame': _wbl['parent_frame'],
            'child_frame': _wbl['child_frame'],
            'translation': [_wbl['translation']['x'], _wbl['translation']['y'], _wbl['translation']['z']],
            'rotation': [_wbl['rotation']['x'], _wbl['rotation']['y'], _wbl['rotation']['z'], _wbl['rotation']['w']]
        }
        
        # Map camera_1 extrinsics (world -> camera_1_link)
        _c1_ext = _calib_data['camera_1']['extrinsics']
        calibrations_dict['ur3e_manilab']['world_pose_realsense_1'] = {
            'parent_frame': _c1_ext['parent_frame'],
            'child_frame': _c1_ext['child_frame'],
            'translation': [_c1_ext['translation']['x'], _c1_ext['translation']['y'], _c1_ext['translation']['z']],
            'rotation': [_c1_ext['rotation']['x'], _c1_ext['rotation']['y'], _c1_ext['rotation']['z'], _c1_ext['rotation']['w']]
        }
        
        # Map camera_2 extrinsics (wrist_3_link -> camera_2_link)
        _c2_ext = _calib_data['camera_2']['extrinsics']
        calibrations_dict['ur3e_manilab']['world_pose_realsense_2'] = {
            'parent_frame': _c2_ext['parent_frame'],
            'child_frame': _c2_ext['child_frame'],
            'translation': [_c2_ext['translation']['x'], _c2_ext['translation']['y'], _c2_ext['translation']['z']],
            'rotation': [_c2_ext['rotation']['x'], _c2_ext['rotation']['y'], _c2_ext['rotation']['z'], _c2_ext['rotation']['w']]
        }
except Exception as _e:
    print(f"Warning: Could not load unified_calibration.json: {_e}")
