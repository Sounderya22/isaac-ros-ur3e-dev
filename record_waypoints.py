...
class WaypointRecorder(Node):
    ...
    def joint_cb(self, msg):
        # Map joints to the standard UR order:
...
def main():
    ...
    print("Waiting for joint states to be published on /joint_states...")
    while rclpy.ok() and node.latest_joints is None:
        pass
    print("Joint states detected successfully!")

    waypoints = []
    print("\n--- Waypoint Recording Active ---")
    print("Instructions:")
    print("  1. Move the arm locally using the robot pendant (freedrive).")
